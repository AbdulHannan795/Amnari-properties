...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AMANRI Properties connects global investors with Dubai's most prestigious off-plan developments. Partnered with Emaar, DAMAC, Sobha, and Nakheel." },
